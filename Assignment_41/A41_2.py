...
Explination :
    ...
    K is  hyperparameter in KNN algo.
    K is used to find nerest element of K size 
    if K change it nerest element are increses
    so the max voting is chnaged.
    so the final class also changed
