...
X_train,X_test,Y_train,Y_test=train_test_split(X,Y,random_state=10,test_size=0.2)  # split the datset in  X_train,X_test,Y_train,Y_test , splait data with 80:20
...
'''
    Explanation : 
            ...
            random_test = 0 then accuracy : 83.33   
            random_test = 10 then accuracy : 83.33 
            random_test = 42 then accuracy : 100  

            the result are the changes 
