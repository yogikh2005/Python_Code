...
# User defined accuracy_score(Y_pred,Y_test)
# Accuracy=(TP+TN)/(FP+FN+TP+TN​)

def accuracy_scoreX(Y_pred, Y_test):
    TP = 0
    TN = 0
    FP = 0
    FN = 0
...
accuracy=accuracy_scoreX(Y_pred,Y_test)                          # calculate testing accuracy of the train model
print("Testing Accuracy(User Define) of the model is : ",accuracy*100) 
...
Explanation : 
            ...
            User Defined accuracy_scoreX is same as built-in accuracy_score
