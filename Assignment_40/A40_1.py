...
print("Model feactues importtance : ")
for i in range(len(model.feature_names_in_)):
    print(" Featcures : ",model.feature_names_in_[i],"feacture_imporantance : ",model.feature_importances_[i])

'''
    Explanation : Attendance have more feature_importances_ 1
                  other remaning have 0
