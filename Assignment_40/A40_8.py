...
plt.title("Decision tree of student case study")

plt.show()

'''
    Explanation : 
                 the Attendance feature is used in root node 
                 Because this split:

                    Completely separated class 0 and class 1

                    Produced zero impurity

                    Achieved maximum possible information gain
