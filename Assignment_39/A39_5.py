...
# Compare Training accuracy & Testing accuracy of the train model
...
Explanation :
              ...
              overfit : whene Train_accuracy is high i.e 100 & Test_accuracy is low i.e 60
              underfit : when Train_accuracy is low i.e 60 & Test_accuracy is low i.e 58

              In current senior review the dataset is low ,Classes are perfectly separable,problem is simple 
              so both are accuracy is 100
'''