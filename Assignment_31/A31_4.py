...
def DirectoryFileCopyExtension(DirectoryName,NewDirectory,Extension):
    Ret=False
    ...
    fobj.write("This is Directory File Copy with Extension Script\n")
    fobj.write(Border+"\n")
    fobj.write("File are :\n")
...
def main():
    ...
    DirectoryFileCopyExtension(DirectoryName,NewDirectory,Extension)
